...
static void test_ecpoint_add_pallas(void **state __attribute__((unused)))
{
  ...
  assert_int_equal(sys_cx_ecpoint_alloc(&ec_p, CX_CURVE_PALLAS), CX_OK);
  assert_int_equal(sys_cx_ecpoint_alloc(&ec_q, CX_CURVE_PALLAS), CX_OK);
  assert_int_equal(sys_cx_ecpoint_alloc(&ec_r, CX_CURVE_PALLAS), CX_OK);
  assert_int_equal(sys_cx_ecpoint_init(&ec_p, p, PASTA_SIZE_u8,
                                       p + PASTA_SIZE_u8, PASTA_SIZE_u8),
                   CX_OK);
  assert_int_equal(sys_cx_ecpoint_init(&ec_q, q, PASTA_SIZE_u8,
                                       q + PASTA_SIZE_u8, PASTA_SIZE_u8),
                   CX_OK);
  assert_int_equal(sys_cx_ecpoint_add(&ec_r, &ec_p, &ec_q), CX_OK);
  assert_int_equal(sys_cx_ecpoint_export(&ec_r, r, PASTA_SIZE_u8,
                                         r + PASTA_SIZE_u8, PASTA_SIZE_u8),
                   CX_OK);
  assert_int_equal(sys_cx_bn_unlock(), CX_OK);
  assert_memory_equal(expected_r, r, sizeof(expected_r));
}
...
static void test_ecpoint_add_vesta(void **state __attribute__((unused)))
{
  ...
  assert_int_equal(sys_cx_bn_lock(PASTA_SIZE_u8, 0), CX_OK);
  assert_int_equal(sys_cx_ecpoint_alloc(&ec_p, CX_CURVE_VESTA), CX_OK);
  assert_int_equal(sys_cx_ecpoint_alloc(&ec_q, CX_CURVE_VESTA), CX_OK);
  assert_int_equal(sys_cx_ecpoint_alloc(&ec_r, CX_CURVE_VESTA), CX_OK);
  assert_int_equal(sys_cx_ecpoint_init(&ec_p, p, PASTA_SIZE_u8,
                                       p + PASTA_SIZE_u8, PASTA_SIZE_u8),
                   CX_OK);
  assert_int_equal(sys_cx_ecpoint_init(&ec_q, q, PASTA_SIZE_u8,
...
static void test_ecpoint_add_jubjub(void **state __attribute__((unused)))
{
  ...
  assert_int_equal(sys_cx_bn_lock(PASTA_SIZE_u8, 0), CX_OK);
  assert_int_equal(sys_cx_ecpoint_alloc(&ec_p, CX_CURVE_JUBJUB), CX_OK);
  assert_int_equal(sys_cx_ecpoint_alloc(&ec_q, CX_CURVE_JUBJUB), CX_OK);
  assert_int_equal(sys_cx_ecpoint_alloc(&ec_r, CX_CURVE_JUBJUB), CX_OK);
  assert_int_equal(sys_cx_ecpoint_init(&ec_p, p, PASTA_SIZE_u8,
                                       p + PASTA_SIZE_u8, PASTA_SIZE_u8),
                   CX_OK);
  assert_int_equal(sys_cx_ecpoint_init(&ec_q, q, PASTA_SIZE_u8,
