...
void test_cavp_sha3_monte_carlo(cx_md_t md_type, uint8_t *initial_seed,
  ...
  assert_int_equal(cx_hash_init_ex((cx_hash_ctx *) &ctx, md_type, digest_size), 1);
...
void test_sha3_224_monte_carlo(void **state __attribute__((unused))) {
  ...
  const uint8_t expected_output[] = {0x91, 0xde, 0xfb, 0xe2, 0x30, 0xb5, 0x14,
                                     0xd7, 0xdb, 0x13, 0xd9, 0x15, 0xa8, 0x23,
                                     0x68, 0xd3, 0x2d, 0x48, 0xf5, 0x5d, 0xb3,
                                     0x1d, 0x16, 0xe3, 0xae, 0x7f, 0xbb, 0xd0};
...
void test_sha3_256_monte_carlo(void **state __attribute__((unused))) {
  ...
  const uint8_t expected_output[] = {
      0x45, 0x6f, 0x2e, 0xd7, 0xf5, 0x43, 0x3b, 0xb4, 0xe5, 0x6d, 0x77,
      0x80, 0xa2, 0x1a, 0x95, 0x3e, 0x95, 0xd6, 0xa5, 0xeb, 0x53, 0xbb,
      0x4c, 0x97, 0x4c, 0x57, 0xa9, 0x0e, 0x67, 0x7f, 0x31, 0x97};
...
void test_sha3_384_monte_carlo(void **state __attribute__((unused))) {
  uint8_t initial_seed[] = {
      0x7a, 0x00, 0x79, 0x1f, 0x6f, 0x65, 0xc2, 0x1f, 0x1c, 0x97, 0xc5, 0x8f,
      0xa3, 0xc0, 0x52, 0x0c, 0xfc, 0x85, 0xcd, 0x7e, 0x3d, 0x39, 0x8c, 0xf0,
      0x19, 0x50, 0x81, 0x9f, 0xa7, 0x17, 0x19, 0x50, 0x65, 0xa3, 0x63, 0xe7,
      0x7d, 0x07, 0x75, 0x36, 0x47, 0xcb, 0x0c, 0x13, 0x0e, 0x99, 0x72, 0xad};
...
void test_sha3_512_monte_carlo(void **state __attribute__((unused))) {
  uint8_t initial_seed[] = {
      0x76, 0x4a, 0x55, 0x11, 0xf0, 0x0d, 0xbb, 0x0e, 0xae, 0xf2, 0xeb,
      0x27, 0xad, 0x58, 0xd3, 0x5f, 0x74, 0xf5, 0x63, 0xb8, 0x8f, 0x78,
      0x9f, 0xf5, 0x3f, 0x6c, 0xf3, 0xa4, 0x70, 0x60, 0xc7, 0x5c, 0xeb,
      0x45, 0x54, 0x44, 0xcd, 0x17, 0xb6, 0xd4, 0x38, 0xc0, 0x42, 0xe0,
      0x48, 0x39, 0x19, 0xd2, 0x49, 0xf2, 0xfd, 0x37, 0x27, 0x74, 0x64,
      0x7d, 0x25, 0x45, 0xcb, 0xfa, 0xd2, 0x0b, 0x4d, 0x31};
...
void test_shake128_monte_carlo(void **state __attribute__((unused))) {
  ...
  const uint8_t result[] = {
      0x4a, 0xa3, 0x71, 0xf0, 0x09, 0x9b, 0x04, 0xa9, 0x09, 0xf9, 0xb1,
      0x68, 0x0e, 0x8b, 0x52, 0xa2, 0x1c, 0x65, 0x10, 0xea, 0x26, 0x40,
      0x13, 0x7d, 0x50, 0x1f, 0xfa, 0x11, 0x4b, 0xf8, 0x47, 0x17, 0xb1,
      0xf7, 0x25, 0xd6, 0x4b, 0xae, 0x4a, 0xe5, 0xd8, 0x7a};
...
void test_shake256_monte_carlo(void **state __attribute__((unused))) {
  ...
  const uint8_t result[] = {
      0xd4, 0xc8, 0xc2, 0x6d, 0xed, 0x38, 0xcc, 0xa4, 0x26, 0xd8, 0xd1, 0xc8,
      0xf8, 0xae, 0xdb, 0x5c, 0x54, 0x35, 0x41, 0x33, 0x38, 0x39, 0xde, 0xca,
      0x87, 0x13, 0xcf, 0xd8, 0x68, 0x44, 0x80, 0xfe, 0x92, 0x3f, 0x57, 0xc3,
      0xa5, 0xc8, 0x9c, 0xb6, 0x14, 0x27, 0xc2, 0x20, 0xc7};
...
void test_keccak_224_short_msg(void **state __attribute__((unused))) {
  test_cavp_short_msg_with_size(TESTS_PATH "cavp/keccak_224_short_msg.data", CX_KECCAK, 28);
}

void test_keccak_224_long_msg(void **state __attribute__((unused))) {
  test_cavp_long_msg_with_size(TESTS_PATH "cavp/keccak_224_long_msg.data", CX_KECCAK, 28);
}

void test_keccak_256_short_msg(void **state __attribute__((unused))) {
  test_cavp_short_msg_with_size(TESTS_PATH "cavp/keccak_256_short_msg.data", CX_KECCAK, 32);
}

void test_keccak_256_long_msg(void **state __attribute__((unused))) {
  test_cavp_long_msg_with_size(TESTS_PATH "cavp/keccak_256_long_msg.data", CX_KECCAK, 32);
}

void test_keccak_384_short_msg(void **state __attribute__((unused))) {
  test_cavp_short_msg_with_size(TESTS_PATH "cavp/keccak_384_short_msg.data", CX_KECCAK, 48);
}

void test_keccak_384_long_msg(void **state __attribute__((unused))) {
  test_cavp_long_msg_with_size(TESTS_PATH "cavp/keccak_384_long_msg.data", CX_KECCAK, 48);
}

void test_keccak_512_short_msg(void **state __attribute__((unused))) {
  test_cavp_short_msg_with_size(TESTS_PATH "cavp/keccak_512_short_msg.data", CX_KECCAK, 64);
}

void test_keccak_512_long_msg(void **state __attribute__((unused))) {
  test_cavp_long_msg_with_size(TESTS_PATH "cavp/keccak_512_long_msg.data", CX_KECCAK, 64);
}
