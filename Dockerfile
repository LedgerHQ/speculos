...
FROM docker.io/library/python:3.9-slim AS builder-pyqt5
...
COPY --from=builder-pyqt5 /usr/local/lib/python3.9/site-packages/ /usr/local/lib/python3.9/site-packages/
