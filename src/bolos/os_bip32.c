                                                     ...
                                                     size_t identifier_length)
{
  ...
  sys_os_perso_derive_node_with_seed_key(HDW_NORMAL, CX_CURVE_SECP256K1, &path,
                                         0, raw_private_key, NULL, NULL, 0);
  ...
  sys_cx_ecfp_generate_pair2(CX_CURVE_SECP256K1, &public_key, &private_key, 1,
                             CX_SHA512);
