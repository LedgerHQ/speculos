...
typedef uint8_t (*USB_DeInit_t)(struct _USBD_HandleTypeDef *pdev, uint8_t cfgidx);

typedef uint8_t (*USB_Setup_t)(struct _USBD_HandleTypeDef *pdev, USBD_SetupReqTypedef *req);
...
typedef uint8_t (*USB_DataIn_t)(struct _USBD_HandleTypeDef *pdev, uint8_t epnum);
typedef uint8_t (*USB_DataOut_t)(struct _USBD_HandleTypeDef *pdev, uint8_t epnum);
typedef uint8_t (*USB_SOF_t)(struct _USBD_HandleTypeDef *pdev);
typedef uint8_t (*USB_IsoINIncomplete)(struct _USBD_HandleTypeDef *pdev, uint8_t epnum);
typedef uint8_t (*USB_IsoOUTIncomplete)(struct _USBD_HandleTypeDef *pdev, uint8_t epnum);
...
typedef uint8_t *(*USB_GetDeviceDescriptor_t)(USBD_SpeedTypeDef speed, uint16_t *length);
typedef uint8_t *(*USB_GetLangIDStrDescriptor_t)(USBD_SpeedTypeDef speed, uint16_t *length);
typedef uint8_t *(*USB_GetManufacturerStrDescriptor_t)(USBD_SpeedTypeDef speed, uint16_t *length);
typedef uint8_t *(*USB_GetProductStrDescriptor_t)(USBD_SpeedTypeDef speed, uint16_t *length);
typedef uint8_t *(*USB_GetSerialStrDescriptor_t)(USBD_SpeedTypeDef speed, uint16_t *length);
typedef uint8_t *(*USB_GetConfigurationStrDescriptor_t)(USBD_SpeedTypeDef speed, uint16_t *length);
typedef uint8_t *(*USB_GetInterfaceStrDescriptor_t)(USBD_SpeedTypeDef speed, uint16_t *length);
typedef uint8_t *(*USB_GetBOSDescriptor_t)(USBD_SpeedTypeDef speed, uint16_t *length);
