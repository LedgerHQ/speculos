...
uint8_t USBD_LEDGER_CDC_data_in(USBD_HandleTypeDef *pdev, void *cookie,
                                uint8_t ep_num);
uint8_t USBD_LEDGER_CDC_data_out(USBD_HandleTypeDef *pdev, void *cookie,
...
uint8_t *USBD_LEDGER_CDC_get_bos_desc(USBD_SpeedTypeDef speed,
                                      uint16_t *length);
