...
const USBD_DescriptorsTypeDef LEDGER_Desc = {
    USBD_get_descriptor_device,
    USBD_get_descriptor_lang_id,
    USBD_get_descriptor_manufacturer,
    USBD_get_descriptor_product,
    USBD_get_descriptor_serial,
    USBD_get_descriptor_product,
    USBD_get_descriptor_product,
    USBD_get_descriptor_BOS,
};
...
uint8_t *USBD_get_descriptor_device(USBD_SpeedTypeDef speed, uint16_t *length)
{
    ...
    memcpy(USBD_desc_device_desc_patched,
           USBD_desc_device_desc,
