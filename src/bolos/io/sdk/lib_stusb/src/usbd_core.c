...
USBD_StatusTypeDef USBD_RegisterClass(USBD_HandleTypeDef *pdev, USBD_ClassTypeDef *pclass)
{
    ...
    if (pdev->pClass->GetFSConfigDescriptor != NULL) {
        pdev->pConfDesc
            = ((USB_GetFSConfigDescriptor_t) PIC(pdev->pClass->GetFSConfigDescriptor))(&len);
    }
...
USBD_StatusTypeDef USBD_SetClassConfig(USBD_HandleTypeDef *pdev, uint8_t cfgidx)
{
    ...
    if (pdev->pClass != NULL) {
        ...
        ret = (USBD_StatusTypeDef) ((USB_Init_t) PIC(pdev->pClass->Init))(pdev, cfgidx);
    }
    ...
    if (epnum == 0U) {
        ...
        if (pdev->dev_state == USBD_STATE_CONFIGURED) {
            if (pdev->pClass->DataOut != NULL) {
                ret = (USBD_StatusTypeDef) ((USB_DataOut_t) PIC(pdev->pClass->DataOut))(pdev,
                                                                                        epnum);
            }
        }
    }
    ...
    if (epnum == 0U) {
        ...
        if (pdev->dev_state == USBD_STATE_CONFIGURED) {
            if (pdev->pClass->DataIn != NULL) {
                ret = (USBD_StatusTypeDef) ((USB_DataIn_t) PIC(pdev->pClass->DataIn))(pdev, epnum);
            }
        }
    }
...
USBD_StatusTypeDef USBD_LL_Reset(USBD_HandleTypeDef *pdev)
{
    ...
    if (pdev->pClassData != NULL) {
        if ((pdev->pClass != NULL) && (pdev->pClass->DeInit != NULL)) {
            (void) ((USB_DeInit_t) PIC(pdev->pClass->DeInit))(pdev, (uint8_t) pdev->dev_config);
        }
    }
...
USBD_StatusTypeDef USBD_LL_IsoINIncomplete(USBD_HandleTypeDef *pdev, uint8_t epnum)
{
    ...
    if (pdev->dev_state == USBD_STATE_CONFIGURED) {
        if (pdev->pClass->IsoINIncomplete != NULL) {
            (void) ((USB_IsoINIncomplete) PIC(pdev->pClass->IsoINIncomplete))(pdev, epnum);
        }
    }
...
USBD_StatusTypeDef USBD_LL_IsoOUTIncomplete(USBD_HandleTypeDef *pdev, uint8_t epnum)
{
    ...
    if (pdev->dev_state == USBD_STATE_CONFIGURED) {
        if (pdev->pClass->IsoOUTIncomplete != NULL) {
            (void) ((USB_IsoOUTIncomplete) PIC(pdev->pClass->IsoOUTIncomplete))(pdev, epnum);
        }
    }
